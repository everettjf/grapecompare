...
test "$(rg -c 'MACOSX_DEPLOYMENT_TARGET = 15.0;' "$project")" -eq 2
! rg -q 'MACOSX_DEPLOYMENT_TARGET = (1[0-4]|[0-9])\.' "$project"
test "$(rg -c 'MARKETING_VERSION = 1.0.2;' "$project")" -eq 2
test "$(rg -c 'CURRENT_PROJECT_VERSION = 37;' "$project")" -eq 2
