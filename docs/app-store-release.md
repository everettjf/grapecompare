...
The validator requires build 35 of Mac App Store version 1.0.0, macOS 15 or
later, both Apple silicon and Intel architectures, App Sandbox, app-scoped bookmarks, user-selected read/write
